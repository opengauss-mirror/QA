...
| 需求                                                         | 开发主体          | 测试主体 | 测试分层策略                                                 |
| ------------------------------------------------------------ | ----------------- | -------- | ------------------------------------------------------------ |
| 行表压缩产品化能力增强                                       | sig-storageengine | sig-QA   | 验证行表压缩的功能、可靠性、性能、资料和长时间稳定性         |
| 发布订阅产品化能力增强                                       | sig-storageengine | sig-QA   | 验证发布订阅的功能、可靠性、资料和长时间稳定性               |
| 支持小型化部署，空载内存底噪<250M，安装包<20M（openEuler默认支持openGauss） | sig-storageengine | sig-QA   | 验证行表压缩的安装部署、功能和资料                           |
| 开源CM集群管理工具，满足openGauss集群管理的要求              |                   | sig-QA   | 验证CM工具的功能、可靠性和资料                               |
| 列存查询能力增强                                             | sig-storageengine | sig-QA   | 验证列存查询能力增强的功能和资料                             |
| 支持系统表syscache的全局缓存                                 | sig-storageengine | sig-QA   | 验证支持系统表syscache的全局缓存的功能、可靠性、资料和长时间稳定性 |
| 当前会话统计中加入归一化SQL，用于慢SQL历史信息诊断           | sig-sqlengine     | sig-QA   | 验证功能和可靠性                                             |
| 支持从可用备机build新的从库，支持build限速                   | sig-storageengine | sig-QA   | 验证备机build的功能、可靠性和资料                            |
| shardingSphere&openGauss改进后端jdbc线程池模型，满足CPU使用率下降10% | 众智              | sig-QA   | 验证改进后jdbc线程池后的功能和性能                           |
| shardingSphere对接openGauss数据库                            | 众智              | sig-QA   | 验证行表压缩的功能、可靠性、性能和长时间稳定性               |
| shardingSphere-jdbc双路由机制                                | 众智              | sig-QA   | 验证shardingSphere对接openGauss数据库的功能和可靠性          |
| 增量迁移性能提升，支持1W tps                                 |                   | sig-QA   | 验证增量迁移的的功能、可靠性和性能                           |
| sql引擎插件化                                                |                   | sig-QA   | 验证sql引擎插件化的功能、兼容性和资料                        |
| 实现FIXED、LONGBLOB等6类数据类型的兼容                       |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| openGauss兼容MySQL条件类型函数                               | 众智              | sig-QA   | 验证本特性的功能和兼容性                                     |
| openGauss兼容MySQL数学函数                                   | 众智              | sig-QA   | 验证本特性的功能和兼容性                                     |
| 支持MySQL时间类型date等类型的兼容                            | 众智              | sig-QA   | 验证本特性的功能和兼容性                                     |
| 实现对MySQL的set数据类型的兼容                               |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| 实现对MySQL的SHA/SHA1/SHA2函数的兼容                         |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| 支持GROUP_CONCAT函数                                         |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| DELETE语句支持从多个表中删除数据                             |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| DELETE语句支持ORDER BY功能                                   |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| 实现IF、HEX、UUID、FORMAT等4个函数的兼容                     |                   | sig-QA   | 验证本特性的功能和兼容性                                     |
| orafce插件支持openGauss                                      | 众智              | sig-QA   | 验证orafce的安装部署、功能和兼容性                           |
| openGauss支持enum数据类型                                    | 众智              | sig-QA   | 验证本特性的功能和兼容性                                     |
| openGauss支持pgfincore的兼容                                 | 众智              | sig-QA   | 验证pgfincore的安装部署、功能、性能和兼容性                  |
| 支持reindex concurrently                                     | 众智              | sig-QA   | 验证本特性的功能和兼容性                                     |
| 开源DataStudio工具                                           |                   | sig-QA   | 验证DataStudio工具的功能、可靠性和资料                       |

# 测试分析设计策略

## 新增feature测试设计策略

| *Domain*           | *Feature*                                                    | *重点*                                                       | *设计思路*                                                   | *备注* |
| ------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------ |
| 内核               | 行表压缩产品化能力增强                                       | 验证不同压缩参数下压缩表的创建、不同压缩率下的数据量，覆盖压缩索引执行DML/DDL等操作，验证同步备、备机重建和主备切换等场景 | 除功能和可靠性场景，还需进行性能测试、长稳测试               |        |
|                    | 发布订阅产品化能力增强                                       | 验证发布端、订阅端的数据同步后的一致性，关注故障场景和大并发场景 | 关注发布端故障时的恢复手段，以及避免订阅端的重复订阅         |        |
|                    | 支持小型化部署                                               | 覆盖支持小型化部署，空载内存底噪<250M，安装包<20M            | 本特性在openEuler中开始默认支持，需要关注和openEuler在三方件上的兼容性，保证安装成功、功能正常 |        |
|                    | 开源CM集群管理工具，满足openGauss集群管理的要求              | 验证CM工具的集群管理能力                                     | 部署openGauss集群，对CM进行功能测试和可靠性测试，包括主机异常重新选主等场景 |        |
|                    | 列存查询能力增强                                             | 覆盖jsonb、json格式；覆盖全文检索、中文检索功能；覆盖merge into支持子查询功能；覆盖支持返回多行函数功能 | 主要验证列存新支持功能                                       |        |
|                    | 支持系统表syscache的全局缓存                                 | 验证新增GUC参数、新增视图和新增函数是否生效                  | 验证global内存淘汰、内存清理函数功能等                       |        |
|                    | 当前会话统计中加入归一化SQL，用于慢SQL历史信息诊断           | 覆盖新增GUC参数、归一化等基本功能测试                        | 结合权限验证、字段一致性和慢查询进行测试                     |        |
|                    | 支持从可用备机build新的从库，支持build限速                   | 验证多备场景，有问题备机build的时候可以从正常备机build       | 从功能、可靠性和大并发维度对支持备机build进行测试，关注备机build是否成功和数据的一致性 |        |
| 全栈分布式解决方案 | shardingSphere&openGauss改进后端jdbc线程池模型，满足CPU使用率下降10% | 验证改进后端jdbc线程池模型，满足CPU使用率下降10%             | 保证改进后的jdbc支持ShardingSphere对接openGauss，并且功能正常，且性能测试满足CPU使用率下降10% |        |
|                    | shardingSphere对接openGauss数据库                            | shardingSphere针对openGauss做协议和驱动适配，使得openGauss所有关键字独立于pg | 按照ShardingSpere支持openGauss的语法兼容说明范围指导测试     |        |
|                    | shardingSphere-jdbc双路由机制                                | 支持基于规则的直连数据库和proxy双重路由，大查询sql支持手动配置路由到proxy | 测试双路由机制的功能，验证手动配置路由到proxy的可行性        |        |
| 工具链             | 增量迁移性能提升，支持1W tps                                 | 利用chameleon工具，实现MySQL到openGauss的数据增量迁移，关键指标1W tps达成 | 验证迁移工具的编译安装，对功能、数据迁移前后的一致性以及1W tps性能指标进行验收 |        |
| 兼容性             | sql引擎插件化                                                | 实现SQL引擎插件化，提取公共接口，并将冗余度降低到80%         | 验证插件的编译安装和关键规格指标达成                         |        |
|                    | 实现FIXED、LONGBLOB等6类数据类型的兼容                       | 验证对FIXED、LONGBLOB、MEDIUMBLOB、TINYBLOB、BINARY、VARBINARY6类数据类型的兼容 | 关注数据类型的结构、语义、约束等，和MySQL保持一致            |        |
|                    | openGauss兼容MySQL条件类型函数                               | 验证对COALESCE、INTERVAL、IFNULL、NULLIP、STPCMP、isnull条件类型函数的兼容 | 关注数据类型的结构、语义、约束等，和MySQL保持一致            |        |
...
|                    | orafce插件支持openGauss                                      | 验证对FIXED、LONGBLOB等6类数据类型的兼容                     | 关注数据类型的结构、语义、约束等，和MySQL保持一致            |        |
|                    | openGauss支持enum数据类型                                    | 验证对enum数据类型的兼容                                     | 关注数据类型的结构、语义、约束等，和MySQL保持一致            |        |
|                    | openGauss支持pgfincore的兼容                                 | 验证pgfincore和openGauss的对接以及查询性能的提升             | 验证pgfincore对接后功能的100%兼容，对性能提升进行摸底        |        |
|                    | 支持reindex concurrently                                     | 验证对reindex concurrently语法的兼容                         | 测试带concurrently关键字进行reindex时，不阻塞其他事务        |        |
|                    | 开源DataStudio工具                                           | 对DS工具进行功能和专项测试，并进行开源前整改，达到开源标准   | 对DS工具进行功能和专项测试，并进行开源前整改，达到开源标准   |        |
...
| **手册名称**   | **覆盖策略**                                                 | **中英文测试策略**                                           |
| -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 《发行说明》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《产品描述》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《技术白皮书》 | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《特性描述》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《编译指导书》 | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《快速入门》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《安装指南》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《管理员指南》 | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《开发者指南》 | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |
| 《工具参考》   | 1、可操作性：按照命令描述进行操作。<br>2、文字逻辑：检查其描述的上下文逻辑，有无目标不清，逻辑混乱，信息冗余，导致读者布置所云的问题。<br>3、网页中超链接是否可正常跳转。 | 1、按照资料描述是否可正确操作。<br>2、结合产品实际情况，描述资料的正确性和合理性。<br>3、检查格式问题以及链接跳转是否正常。 |

# 测试执行策略

openGauss 3.0.0 Release版本按照社区release-management团队既定的版本计划，共有9轮测试，按照社区研发模式，所有的需求在2022年2月20日前完成合入。版本计划规划9轮测试，采取6+3的测试方式，即6轮系统测试+3轮集成验证的策略。
...
| :---- | :---- | :---- |
| Test round 1 | 2022-1-13 | 2022-1-19 |
| Test round 2 | 2022-1-20 | 2022-1-26 |
| Test round 3 | 2022-1-27 | 2022-1-30 |
| Test round 4 | 2022-2-10  | 2022-2-16 |
| Test round 5 | 2022-2-17  | 2022-2-19 |
| Test round 6 | 2022-2-20 | 2022-2-27 |
| Test round 7 | 2022-2-28 | 2022-3-3 |
| Test round 8 | 2022-3-4 | 2022-3-9 |
| Test round 9 | 2022-3-10 | 2022-3-12 |

...
## 1.3 已适配系统函数统计
PostgreSQL9.6.3+TimescaleDB 1.7.4合计系统函数67个。openGauss适配TimescaleDB插件，涉及28个系统函数无法适配(明细见：openGauss无法适配TimescaleDB系统函数表格)，可适配系统函数39个，第一阶段适配系统函数23个，第一阶段适配的系统函数占可适配系统函数的比例为58.9%。

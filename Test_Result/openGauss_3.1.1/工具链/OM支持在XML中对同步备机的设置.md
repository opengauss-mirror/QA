...
OM支持在XML中对同步备机的设置共计执行19条用例，主要覆盖了功能测试、资料测试。功能测试验证了ANY、FRIST方式指定同步备，通过该方式制定同步备后进行数据安装，同步备生效且准确。资料测试中描述恰当，示例正确无误。共计发现6个问题，其中6个问题已解决。问题均回归通过，无遗留风险，整体质量良好。
...
| :----------------------------: | :--------: | :------------------: | :----------: |
| openGauss 3.1.0 build 0d771b43 |     19     | Passed：19 Failed：0 |      6       |

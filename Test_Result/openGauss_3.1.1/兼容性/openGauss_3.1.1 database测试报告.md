...
| openGauss 3.1.0 build ece73c7d | 2022-12-01 | 2022-12-22 |
...
openGauss dolphin插件MySQL兼容database，共计执行30个用例，主要覆盖了功能测试、约束测试、资料测试。功能测试覆盖了入参测试以及特性测试；约束测试验证了database的测试用例在非兼容“B”库下执行数据库可稳定运行；测试中发现0个问题。

...
openGauss dolphin插件MySQL兼容row_count函数，共计执行94个用例，主要覆盖了功能测试、约束测试、资料测试。功能测试覆盖了row_count函数基础测试以及特殊场景测试；约束测试验证了row_count函数的测试用例在非兼容“B”库下执行数据库可稳定运行；测试中发现2个问题，2个问题已取消。

...
共设计4个测试用例，分别覆盖了2节点、3节点和15节点tpcc性能测试，以及2节点24小时长稳测试。15节点tpcc性能的测试结果为1246万 tpmC，未达到1300万目标，测试不通过。

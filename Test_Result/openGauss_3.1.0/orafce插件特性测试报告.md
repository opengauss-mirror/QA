...
| 测试步骤：                                                   | 测试结果                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 1. 编译安装openGauss数据库<br/>2. 编译orafce插件 <br/>3. 安装插件 <br/>4. 执行用例 <br/>5. 删除orafce插件 | 执行1条用例，发现1条问题<br/>问题已修复且验证通过，执行结果符合预期 |
...
| 测试步骤：                                                   | 测试结果                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 1. 安装orafce插件<br/>2. 执行兼容函数相关用例<br/>3. 环境清理<br/>4. 删除orafce插件 | 执行90条用例，发现6个问题<br/>5条已修复且验收通过，1条非问题已取消，执行结果符合预期 |

...
### 4.2.1   单表数据量size递增，平均校验速度

<center> 表1  单表数据总量递增平均校验速度
</center>

| 数据总数(万条) | 总size(MB) | 平均校验速度（MB/s） |
| :------------: | :--------: | :------------------: |
|      16.3      |    300     |          30          |
|       33       |    600     |        46.15         |
|      170       |    3072    |        122.8         |
...
### 4.2.2   三张表总数据量size递增，平均校验速度

<center>表2  三张表数据总量递增平均校验速度</center>
...
<center>表3  六张表数据总量递增平均校验速度</center>
| 数据表（个） | 数据总数(万条) | 总size(MB) | 平均校验速度（MB/s） |
| :----------: | :------------: | :--------: | :------------------: |
|      6       |     51.13      |    300     |        13.04         |
|      6       |     102.26     |    300     |        26.09         |
...
<center> 表4  八张表数据总量递增平均校验速度</center>
| 数据表（个） | 数据总数(万条) | 总size(MB) | 平均校验速度（MB/s） |
| :----------: | :------------: | :--------: | :------------------: |
|      8       |     36.21      |    300     |        11.11         |
|      8       |     72.42      |    600     |        21.43         |
...
<center> 表5  十张表数据总量递增平均校验速度</center>
| 数据表（个） | 数据总数(万条) | 总size(MB) | 平均校验速度（MB/s） |
| :----------: | :------------: | :--------: | :------------------: |
|      10      |     43.82      |    300     |         9.38         |
|      10      |     87.64      |    600     |        18.18         |

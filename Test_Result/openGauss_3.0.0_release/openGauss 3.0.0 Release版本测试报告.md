...
openGauss 3.0.0 Release版本版本共发现问题xx个，有效问题xx个，遗留问题xx个（详见遗留问题章节），其他问题均已修复，回归测试结果正常。版本整体质量较好。
...
| 升级路径                               | 测试结论 |
| -------------------------------------- | -------- |
| openGauss1.1.0灰度升级到openGauss3.0.0 | XX       |
| openGauss2.0.0灰度升级到openGauss3.0.0 | XX       |
| openGauss2.0.1灰度升级到openGauss3.0.0 | XX       |
| openGauss2.1.0灰度升级到openGauss3.0.0 | XX       |
...
openGauss 3.0.0 Release版本共发现问题单164个，有效问题160个，其中修复问题单XX个，回归均通过。详细分布见下表: 

| 版本名称                    | 测试起始时间 | 测试结束时间 | 问题单数 |
| --------------------------- | ------------ | ------------ | -------- |
| openGauss 3.0.0 Release RC1 | 2022-1-20    | 2022-1-26    | 21       |
| openGauss 3.0.0 Release RC2 | 2022-1-27    | 2022-1-30    | 10       |
| openGauss 3.0.0 Release RC3 | 2022-2-10    | 2022-2-16    | 39       |
| openGauss 3.0.0 Release RC4 | 2022-2-17    | 2022-2-19    | 8        |
| openGauss 3.0.0 Release RC5 | 2022-2-20    | 2022-2-27    | 24       |
| openGauss 3.0.0 Release RC6 | 2022-2-28    | 2022-3-9     | 39       |
| openGauss 3.0.0 Release RC7 | 2022-3-10    | 2022-3-12    | 18       |
| openGauss 3.0.0 Release RC8 | 2022-3-14    | 2022-3-15    | 5        |
...
| 序号 | issue号 | 问题简述 | 问题级别 | 问题分析与对策 | 规避措施 | 备注 |
| ---- | ------- | -------- | -------- | -------------- | -------- | ---- |
|      |         |          |          |                |          |      |
|      |         |          |          |                |          |      |
|      |         |          |          |                |          |      |

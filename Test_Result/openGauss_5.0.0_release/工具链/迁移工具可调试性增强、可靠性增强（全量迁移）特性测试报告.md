...
| mysql 5.7<br/>openGauss 5.0.0 build 8c9b36a9<br/>chameleon-3.1.1 | 5         | Passed：5<br>Failed：0 | 0            |

*数据项说明：*

* 累计发现缺陷单6个，6个缺陷均已解决且回归通过
* 缺陷密度为4(缺陷个数)/181(代码行数)=0.02(个/kloc)

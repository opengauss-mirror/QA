...
| 功能测试 | 分别测试编译安装、以OM方式安装、带CM安装、极简安装数据库并执行sql语句，测试达到预期结果 |
...
| 测试步骤：                                                   | 测试结果                         |
| ------------------------------------------------------------ | -------------------------------- |
| 1.在x86架构PAGE_SIZE=4k、arm架构PAGE_SIZE=4k和arm架构PAGE_SIZE=64k的openEuler 22.03LTS系统分别测试编译安装、以OM方式安装、带CM安装、极简安装数据库并执行sql语句以及测试om/cm工具的使用，以及轻量版安装测试 | 共执行21条用例，执行结果符合预期 |

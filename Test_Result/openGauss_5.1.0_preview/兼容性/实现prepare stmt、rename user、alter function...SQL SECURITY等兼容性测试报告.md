...
| 版本名称                                  | 测试起始时间 | 测试结束时间 |
| :---------------------------------------- | :----------- | :----------- |
| M* 5.7<br />openGauss5.1.0 build 1c922789 | 2023-4-21    | 2023-5-12    |
| M* 5.7<br />openGauss5.0.0 build 68d1772f | 2023-5-24    | 2023-5-26    |
| M* 5.7<br />openGauss5.0.0 build 39f999f9 | 2023-6-6     | 2023-6-19    |
...
| 测试步骤                                                     | 测试结果                               |
| ------------------------------------------------------------ | -------------------------------------- |
| 1.对函数入参个数、入参类型、与其他函数交互、在存储过程及自定义函数中使用语法及函数、结合条件筛选语句等方面对语法及函数进行测试。 | 共执行测试用例255条<br />发现16个bug。 |

## 4.2   性能测试

| 测试步骤                                                     | 测试结果                           |
| :------------------------------------------------------------ | :---------------------------------- |
| 1.对函数在openGauss侧执行与M*侧执行进行性能对比。 | 共执行测试用例16条<br />发现1个bug。 |
...
注：部分函数性能时间比值大于1，经过sig组评审后确定问题原因不在于函数，故保持现状，暂不解决。

## 4.3   资料测试

| 测试步骤                                 | 测试结果     |
| :--------------------------------------- | :----------- |
| 1.验证语法及函数资料描述及示例是否正确。 | 发现1个bug。 |

## 4.4   测试执行统计数据

| 版本名称                      | 测试用例数 | 用例执行结果            | 发现问题单数 |
| :----------------------------- | :---------- | :----------------------- | :------------ |
| openGauss5.0.0 build 1c922789 | 255 | Passed:255<br />Failed:26 | 15      |
| openGauss5.0.0 build 68d1772f | 26 | Passed:23<br />Failed:3 | 3 |
| openGauss5.0.0 build 39f999f9 | 255 | Passed:255<br />Failed:0 | 0 |

缺陷单共18个，修改代码量为4.54kloc， 缺陷密度为3.96个/kloc

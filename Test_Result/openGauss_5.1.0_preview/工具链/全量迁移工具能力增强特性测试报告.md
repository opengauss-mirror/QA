...
| ------------------------------------------------------------ | -------- | ------------------------------------------------------------ | ---------------------------------------- | -------- |
| [I80FTM](https://gitee.com/opengauss/openGauss-tools-chameleon/issues/I80FTM?from=project-issue) |          | chameleon迁移日期时间类型及二进制类型，日期时间类型迁移成功，但迁移日志有报错，二进制类型，迁移后数据有误次要 | 目前迁移后二进制有问题，转入下个版本解决 | 待办的   |

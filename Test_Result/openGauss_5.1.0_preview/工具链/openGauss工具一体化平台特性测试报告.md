...
| 日期      | 修订   版本 | 修改描述               | 作者        |
| :-------- | ----------- | ---------------------- | ----------- |
| 2023-3-13 | 1.0         | 特性测试报告初稿完成    | yangyixiang |
| 2023-6-7  | 1.1         | 增加新添加特性测试结论 | yangyixiang |
| 2023-10-11  | 1.2         | 修改报告遗留问题 | yangyixiang |
...
| openGauss-visualtool<br/>base-ops 5.0.0<br/>data-migration<br/>M* 5.7.41<br/>openGauss 5.1.0<br/>Chrome 111.0.5563.64<br/>Firefox 18.5.0.0 | 2023-7-1     | 2023-9-22    |
...
| openGauss-visualtool<br/>base-ops 5.0.0<br/>data-migration<br/>M* 5.7.41<br/>openGauss 5.1.0<br/>Chrome 111.0.5563.64<br/>Firefox 18.5.0.0 | 20 | Passed：20<br/>Failed：0 | 0 |

*数据项说明：*

* 累计发现缺陷单98个，6个为资料单，98个缺陷均已解决且回归通过。

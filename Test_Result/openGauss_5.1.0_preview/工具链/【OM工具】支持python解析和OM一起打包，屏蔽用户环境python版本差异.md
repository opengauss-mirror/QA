...
| 虚拟机   | CPU：Intel(R) Xeon(R) Gold 6266C CPU @ 2.60GHz<br/>内存：16GB<br/>硬盘：64GB<br/>OS：openEuler release 22.03(LTS-SP1)_x86_64 |      |
# 3     测试结论概述
...
* 累计发现缺陷单3个，其中1个为其他需求影响，1个为资料单，3个缺陷均已解决且回归通过

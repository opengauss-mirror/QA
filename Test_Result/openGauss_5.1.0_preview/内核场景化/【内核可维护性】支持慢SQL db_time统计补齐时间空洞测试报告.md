...
| 测试步骤                                                     | 测试结果                       |
| ------------------------------------------------------------ | ------------------------------ |
| 1. 测试执行DDL，DML以及DCL等sql的执行总时间与子时间之间的误差不超过10%；<br/>2. 测试事务中的sql执行总时间与子时间之间的误差不超过10%；<br />3. 测试备机上执行sql总时间与子时间之间的误差不超过10%；<br />4. 测试主备switchover/failover之后执行sql总时间与子时间之间的误差不超过10%。 | 执行测试用例96条<br />测试通过 |

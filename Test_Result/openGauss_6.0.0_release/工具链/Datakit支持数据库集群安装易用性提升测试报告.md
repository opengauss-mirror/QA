...
| ------------------------ | -------------------- | ------------ | ------------ | -------- |
| Datakit 6.0.0 8-09latest | Datakit-6.0.0.tar.gz | 2024-08-09   | 2024-08-12   | 李锦波   |
| Datakit 6.0.0 8-12latest | Datakit-6.0.0.tar.gz | 2024-08-12   | 2024-08-13   | 李锦波   |
...
安装包管理易用性提升，共执行用例15个，主要覆盖了功能测试。功能测试主要覆盖安装包管理，执行日志管理等。资料测试覆盖校验资料的描述是否完整，可读性高。累计发现缺陷单4个，4个缺陷已解决，回归通过，整体质量良好。
...
| ---- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ | ------ | ---- |
| 1    | [IAJFM7](https://e.gitee.com/opengaussorg/dashboard?issue=IAJFM7) | 次要 | 【测试版本：6.0.0】datakit安装包管理页签须与官网保持一致     | 已验收 |      |
| 2    | [IAJBPW](https://e.gitee.com/opengaussorg/dashboard?issue=IAJBPW) | 次要 | 【测试版本：6.0.0】datakit进入安装包管理页签后，切换其他页签为空 | 已验收 |      |
| 3    | [IAJAGC](https://e.gitee.com/opengaussorg/dashboard?issue=IAJAGC) | 次要 | 【测试版本：6.0.0】datakit安装包管理页签，点击修改或下载时，取消按键无法使用 | 已验收 |      |
| 4    | [IAJAAN](https://e.gitee.com/opengaussorg/dashboard?issue=IAJAAN) | 次要 | 【测试类型：功能测试】【测试版本：6.0.0】datakit安装包管理页签/安装包下载必填项为空值时安装包下载成功 | 已验收 |      |
...
| ---- | ----------------------------------- | ------------------------------------------------ | -------------------- |
| 1    | Datakit支持数据库集群安装易用性提升 | *测试设计阶段与测试owner、TSE、SE对齐的测试策略* | YES                  |
|      |                                     |                                                  |                      |
|      |                                     |                                                  |                      |
...
| ------------------------------ | ---------------- | ---------- | ---------- | ---------- | -------------- | -------- |
| Datakit build time：2024-08-09 | 2                | 15         | 15         | 4          | 0.897          | 4.45     |
| Datakit build time：2024-08-12 | 1                | 15         | 15         | 0          | 0.897          | 0        |
...
| ------------------------------ | ---------- | ------------------------------------- | ------------ |
| Datakit build time：2024-08-09 | 15         | Passed:11<br/>Failed:4<br />Blocked:0 | 4            |
| Datakit build time：2024-08-12 | 15         | Passed:15<br/>Failed:0<br />Blocked:0 | 0            |
...
*集群并行任务管理功能部分三（含部分安装包功能）
https://e.gitee.com/opengaussorg/repos/opengauss/openGauss-workbench/pulls/736?tab=files*
